...
Oz ships as a signed desktop bundle. Download the installer for your platform from the [Releases](https://github.com/my-oz/oz/releases/latest) page. Oz auto-updates from there.

## macOS

Two separate `.dmg` builds - one for Apple Silicon (aarch64), one for Intel (x86_64). Pick the one that matches your hardware on the [Releases](https://github.com/my-oz/oz/releases/latest) page, drag Oz to `/Applications`, and launch.
